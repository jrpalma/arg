...
// If usage is displayed, the help string will be used to document the flag.
func (fs *CmdFlagSet) ReqArgs(name string, short string, names []string, help string) {
...
// Names are the names of the ordered arguments for the this flag.
// If usage is displayed, the help string will be used to document the flag.
func (fs *CmdFlagSet) OptArgs(name string, short string, names []string, help string) {
